...
export const getAddCart = ErrorWrapper(async (req, res, next) => {
    ...
    try {
        ...
        let cartItem = { food: foodItem, quantity, restaurantName: restaurant_name, category: category };
...
export const getCartItemIncrease = ErrorWrapper(async (req, res, next) => {
    ...
    try {
        ...
        if (!restaurant) {
            throw new ErrorHandler(404, `Restaurant with name ${restaurant_name} is not exists!`);
        }
